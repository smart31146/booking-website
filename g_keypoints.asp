...
<div class="page-content">
	<div class="white-container">
		...
		<div class="allcontent h-100">
			<div class="allcontent_main h-100 m-0 w-100">
				<div class="menu_content" style="width: 230px;max-height: 100%;overflow-y: overlay;">
					...
					<div class="main_content mt-0 mb-0" style="width: 700px;margin-left: 20px;max-height: 100%;overflow-y: overlay;">
						<h1>Key points <%=ReplaceStrBBG(header("topic_title"))%></h1><br>
						
						<%IF header("topic_keyp") <> "" THEN response.write Highlight(ReplaceStrBBG(header("topic_keyp"))) ELSE response.write "There are no key points on this topic"%>
						<br><br>
							<div class="back_blue">
			...
			<%
			call log_the_page ("Guide Key Points", Session("id"), session("name"), "0", "n/a", "0", "n/a", "Guide Key Points")
			%>
		</div>
