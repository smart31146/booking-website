		   ...
		   /* $("#ele2").find('.print-link').on('click', function() {
                                        ...
                                        $("#ele1").find('.print-link').on('click', function() {
                                            ...
                                            $("#ele1").print({
                                                ...
                                                //Add this at top
                                                prepend : "<div class='header_inside' style='text-align:center'><img  style='width:100px' src='images/logo_certficate.jpg' /><h4>BETTER BUSINESS PROGRAM CERTIFICATE</h4> <h3> <% =subject("subject_name")%></h3></div>",
                                                //Add this on bottom
                                                append : "<br/>!",
												timeout: 2000
                                            });
...
<img src="images/bg.jpg" alt="background image" id="bg" class="background-image">
	...
	<div class="main_content2">
		<div class="guide_blue">
			<div class="box_inside2" >
			 <div id="ele1" class="a">
			 <div class='header_inside_image' style='text-align:center;'><img  style='width:100px' src='images/logo_certficate.jpg' /><h4 style="margin-top:10px;">BETTER BUSINESS PROGRAM CERTIFICATE</h4> <h3style="margin-top:15px;"> <% =subject("subject_name")%></h3></div>
			
			<% if Session("LMS") = 1 then %>
				<!--<br><br>Click button below to save your results and return to the LMS. -->
				<strong><img src="images/img_expiredg.png"/> After you view your results click on ‘Return to LMS' below. Do not click ‘Save & Close’.</strong>
				<br><br><strong> You will also be returned to the LMS automatically in <span id="countdown" style="font-size:20px;color:red;">10</span> <span id="second">seconds</span></strong>.
		<br>
				<% END IF%>
			
			<h5 "margin-top:20px;"><span  style="color:#0354AC">Date Completed: </span><span style="color:#0354AC"><%= FormatDateTime(Date, 1) %> at <%= FormatDateTime(Now, 3) %></span></h5>
...
if Session("LMS") = 1 then
 ...
 MM_editConnection = Connect
  ...
  MM_editQuery = "update " & MM_editTable & " set session_done = " & session_completed & ", session_correct = " & total_correct & ", session_finish = '" & cDateSql(Now())&"' " & "where ID_session = " & SessionID
...
%>
            ...
            <br>The passmark for this subject is <%=subject_passmark%>%. You achieved  <%=FormatNumber(percentage_achieved,2)%>% for this quiz which is a
			<% if(pass_or_fail=1) then %>
				<span style="color:green"><strong>PASS.</strong></span><br><br>
				<strong>Congratulations! </strong> You can print this certificate using the link below. To finish – you can either close the browser or click on the link below to return to the homepage.
<br>
				 
			<% else %>
				<span style="color:red"><strong>FAIL.</strong></span><br><br><strong>You are required to complete this subject again.</strong> <br><br>Click button below to return to the LMS where you can start this subject again. Do not press ‘Save & Close’. Press ‘Return to LMS’.
	...
	<%else%>
	<div class="certificate_buttons avoid-this">
		
		<br>
					 <div>
                     <div class="return_blue" style="display: inline;"> <a style="padding-left: 5px;" href="lmscallback.asp?SessionBBP=<%=SessionID%>"> Return to LMS</a></div>
					 <div class="just_blue" style="display: inline;"> <a href="javascript:void(0)" style="color:#fff;padding:0px;"  class="print-link"> Print this page </a></div>
					 </div>
	...
	<div class="certificate_buttons avoid-this">
		    <div class="just_blue">
		<a href="javascript:void(0)" style="color:#fff;padding:0px;"  class="print-link"> Print this page </a>
				</div>
...
countredirect();
		window.setTimeout("document.location = 'lmscallback.asp?SessionBBP=<% =SessionID%>';", 10000);
