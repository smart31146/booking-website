...
<head>
    ...
    <title><%=client_name_short%> - Better Business Program</title>
	 ...
	 <link href="perfect-scrollbar-0.4.8/src/perfect-scrollbar.css" rel="stylesheet">
      <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js?v=bbp34"></script>
        ...
        <div class="guide_blue">
            ...
            IF showQuestion = true THEN
                ...
                xi = 0
                     For i=0 to ubound(QArr,2)
                     xi=xi+1 %>
                    <div class="t_choose" id="button<% =QArr(0,i)%>"><a href="#answer" onclick="javascript:showlayer('layer<% =QArr(0,i)%>','button<% =QArr(0,i)%>'); b_click=false;"><% =ReplaceStrQuiz(QArr(1,i))%></a></div>
                    <% IF xi=2 THEN
                    xi=0
            ...
            <div class="clear"></div>
                ...
                <div class="certificate_blue">
                    <div class="h_submit_blue"><a onClick="window.open('t_question_window.asp?s_id=<% =subject("s_goback")%>','bppWindow','width=620,height=425,left=20,top=20,scrollbars=yes')" href="javascript:void(0)" class="box_link" style="padding-left:15px;">GO BACK AND SEE THIS SCENARIO AGAIN</a></div>
                </div>
                <div class="clear"></div>
                <% END IF%>
                  <br>
                        ...
                        <% 
                         ...
                         END IF%><br>
                            <div class="div_button" style="width:860px;text-align:right;margin:20px 0px;">
                                <input type="Image" src="images/button_submit.png" name="btnSubmit" id="btnSubmit" value="SUBMIT">
                            </div>
                        </form>
                    </div>
                </div>
