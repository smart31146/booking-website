...
<div class="menu_content">
	...
	<div class="header_blue" style="width:300px;height:50px;">
		<div class="header_inside"><h3 style="font-size:16px;">	<% =ReplaceStrBBG(session("name"))%></h3>
		</div>
	</div>
			...
			%>
			<div class="t_menu_blue_active">
			<% ELSE%>
			<div class="t_menu_blue">
			<% END IF%>
				<a href="g_index.asp?ID_topic_prm=<%=(topics("ID_topic"))%>"><%=ReplaceStrBBG(topics("topic_name"))%></a>
			</div>
        	<%topics.MoveNext()
			Wend %>		
...
<% if  Instr(exmessage, exm) = 0  or Instr(keymessage, keym) = 0  then  %>
	...
	<div class="box_grey">
		...
		<div class="box_inside"><h2>Topic Highlights!</h2>
...
<div class="main_content" style="margin-left:20px;" id="main_content">
<!--
