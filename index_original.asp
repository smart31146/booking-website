...
<script>
    function(doc) {
        ...
        if ( navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPod/i)) {
            ...
            viewport.setAttribute("content", "initial-scale=1.00");
        }
    }(document));
</script>
...
<body  >
<% IF pref_admin_color = "default"  THEN %>
<img src="images/bg.jpg" alt="background image" id="bg">
<%else%>
<script>
$('body').css("background", "<%=pref_admin_color%>")
<%end if%>
</script>
...
<div class="main_content" id="dd" >
  ...
  <div style="background: url('images/start_main.jpg') no-repeat;width:600px;height:300px;position:relative;" >
    <div style="position:absolute;left:205px;top:15px;color:#fff;width:370px;"><strong>Welcome to the Better Business Program</strong>
...
<form role="form" method="post" action="index.asp?alt=login" onsubmit="return(checkLogin());">
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="bbp_username" id="bbp_username"  placeholder="Enter Username">
    </div>
    <div class="form-group">
      
      <input type="password" class="form-control" name="bbp_password" id="bbp_password" placeholder="Enter password">
    </div>
  ...
  <% IF request.querystring("error")="login" THEN response.write "<script>swal({   title: ""The Username or Password you entered is incorrect."",   text: ""Your username is  your <b>firstname.lastname</b>  (e.g. JOHN.SMITH )<br><br>If you have forgotten your password, you can click 'Forgotten Password' below to reset your password."",   type: ""error"",   confirmButtonText: ""OK"",html: true });</script>" %>
    ...
    <button id="login" type="Submit" class="btn btn-default" value="Log in" >Log in</button>
 
<br>
<br>
<% IF pref_self_reg THEN %>
      
      <a id="registerLink" href="#"  data-toggle="modal" data-target="#myModal" >I'm a new user</a> | 
      <% END IF %>
<% IF pref_forgot_pass THEN %>
<a  id="forgot" href="#" data-toggle="modal" data-target="#passModal" >Forgot your username or password?</a>
<% END IF %>
    ...
    <!--  You will be taken through a number of topics on this subject.<br>
      ...
      questions that relate to that topic. You can leave the training at any time<br>and you will be taken back to the start of the topic you were working on.<br>-->
        ...
        <div class="submit_blue">
          <div class="h_submit_blue"><a  class="box_link" href="t_index.asp?ID_subject_prm=<%=Session("id")%>" style="padding-left:15px;"> START YOUR TRAINING (<%=UCASE(ReplaceStrBBG(Session("name")))%>)</a></div>
        </div>
...
<div class="modal fade" id="passModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <iframe   id="getpassmodal" src="" width="500" height="400" frameborder="0" allowtransparency="true"></iframe>  
      </div>
