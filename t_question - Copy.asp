...
<!-- #include file = "main_top.asp" -->
    ...
    <div class="header_blue">
        ...
        <div class="header_progress" style="padding-top:28px;">
            <div class="topic_progress"><strong>Topic</strong> <div class="topicNumberCircle"><%=topicPosition%></div> of <%=totalTopics%></div>
            <div class="page_progress"><strong>Page</strong> <div class="pageNumberCircle"><%=subject("s_order") - previousTopicEnd%></div> of <%=totalTopicQuestions%> in this topic</></div>		
        </div>
