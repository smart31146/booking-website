       ...
       ' boolean to abort record edit
        ...
        ' query string to execute
            ...
            If Not ObjRS1.EOF Or Not ObjRS1.BOF Then
                ...
                Response.Write("<BR>User Name: <b>" & ObjRS1("user_username") & "</b> already exists and is active = " & ObjRS1("user_active")) & "<br>"
...
'uobj.ActiveConnection.Close
				...
				'count=count+1
				'Response.Write("<BR>NEW USER<BR>" &count)
             End If
             ObjRS1.Close
             Set ObjRS1 = nothing
...
%>
 ...
 <%
   '***************************************************Main Body of the Program************************************************
        ...
        Path = "C:\www\BBP\BBP_asahi\admin"
