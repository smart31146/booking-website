...
<TITLE>BBP ADMIN: Training subjects. You are logged in as <%=Session("MM_Username_admin")%></TITLE>
...
%>
              ...
              <tr valign="middle"> 
                ...
                <td align="left">&nbsp;<img src="images/bar0.gif"><img src="images/bar1.gif" height ="9" width="<%=Int(bar_current_length/bar_max_length*stat_bar_length)%>" ><img src="images/bar2.gif"> 
...
<%
call log_the_page ("Training Subjects Stats")
%>
