...
<%
Dim id_replace
If (Request.QueryString("id_replace") <> "") Then 
id_replace = cInt(Request.QueryString("id_replace"))
Else 
...
If (CStr(Request("MM_delete")) <> "" And CStr(Request("MM_recordId")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    call log_the_page ("BBG Execute - DELETE Replace: " & MM_recordId)	
...
p_del.Source = "SELECT ID_replace FROM toreplace WHERE ID_replace = " + Replace(id_replace, "'", "''") + ""
p_del.CursorType = 0
...
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
  ...
  <input type="hidden" name="MM_recordId" value="<%= p_del.Fields.Item("ID_replace").Value %>">
</form>
</body>
</HTML>
<%
