...
for iii = 1 to cInt(Request.form("field_length"))
  ...
  MM_editRedirectUrl = "q_list_of_subjects.asp?subj=" & subj
  ...
  If (Not MM_abortEdit) Then
    ...
    call log_the_page ("Quiz Execute - UPDATE Topics: " & MM_recordId)
  End If
next
...
<TITLE>BBP ADMIN: Quiz topics order. You are logged in as <%=Session("MM_Username_admin")%></TITLE>
...
return confirm("Do you realy want to save changes in question ordering?");
}
//-->
</script>
</HEAD>
...
<table>
  <tr> 
    <td align="left" valign="bottom" class="heading"> Quiz topics order</td>
  </tr>
  <tr> 
...
<%
call log_the_page ("Quiz Reorder Topics " & subj)
%>
