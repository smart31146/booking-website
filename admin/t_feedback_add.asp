...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  MM_columnsStr = "feedback_text|',none,''|feedback_ID_page|none,none,NULL|feedback_head|',none,''|feedback_UID|',none,''"
...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    call log_the_page ("Training Execute - INSERT Feedback")
...
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
  ...
  <input type="hidden" name="label" value ="Correct!">
