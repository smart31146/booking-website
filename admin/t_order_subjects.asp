...
for iii = 1 to cInt(Request.form("field_length"))
  ...
  If (Not MM_abortEdit) Then
    ...
    call log_the_page ("Training Execute - UPDATE Subjects: " & MM_recordId)	
  End If
next
...
subjects.Source = "SELECT subjects.ID_subject, subjects.subject_name, subjects.subject_active_t, subjects.ID_subject  FROM subjects  GROUP BY subjects.ID_subject, subjects.subject_name, subjects.subject_active_t, subjects.subject_ord, subjects.ID_subject  ORDER BY subjects.subject_ord, subjects.ID_subject;"
...
<TITLE>BBP ADMIN: Training subjects order. You are logged in as <%=Session("MM_Username_admin")%></TITLE>
...
<table>
  <tr> 
    <td align="left" valign="bottom" class="heading"> Training subjects order</td>
  </tr>
  <tr> 
...
<%
call log_the_page ("Training Reorder Subjects")
%>
