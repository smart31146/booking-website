...
function pass_submit()
{
	...
	{
		document.filter_users.action="q_list_of_users.asp"
...
<table>
  ...
  <tr>
    <td align="left" valign="bottom">
      <form name="filter_users" action="q_list_of_users_results.asp">
     <input type="hidden" name="hiddenmths" value="false">
		...
		<tr class="table_normal">
          ...
          <tr class="table_normal">
            <td class="text" width="18">&nbsp;</td>
            <td class="text" valign="top" width="143">LMS username (email address) or firstname</td>
            <td class="text" valign="top" colspan="7">
...
%>
		  ...
		  <tr class="table_normal">
            <td class="text" width="18">&nbsp;</td>
            <td class="text" valign="top" width="143">Site:</td>
            <td class="text" valign="top" colspan="8">
...
%>
		  ...
		  <% IF pref_offline THEN %>
		   <tr class="table_normal">
            <td class="text" width="18">&nbsp;</td>
            <td class="text" valign="top" width="143">Status:</td>
            <td class="text" valign="top" colspan="8">
              <select name="status" class="formitem1">
			   <%if cstr(request("status"))="" or cstr(request("status")="0") then%>
			  
               <option value="0" selected>Online/offline
               <option value="1">Online
               <option value="2">Offline
              <%elseif cstr(request("status"))="1" then%>
			  
               <option value="0">Online/offline
               <option value="1" selected>Online
               <option value="2">Offline
              <%elseif cstr(request("status"))="2" then%>
			  
               <option value="0">Online/offline
               <option value="1">Online
               <option value="2" selected>Offline
              <% end if %>
              </select>
            </td>
          </tr>
	...
	<tr class="table_normal">
	            <td class="text" width="18">&nbsp;</td>
	            <td class="text" valign="top" width="143">User latest sessions:</td>
	            <td class="text" valign="top" colspan="8">
	              <%
	              if cstr(request("mths"))="1" then %>
	...
	<tr class="table_normal">
		...
		<tr class="table_normal">
                  <td colspan="10" class="text"> <br><BR>
                    <b><font color="red">PLEASE NOTE:</font></b> There are a large number of quiz user records.  You should set the filter options above to return only the specific user records that you
