...
if (CStr(Request("MM_delete")) <> "" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "b_list_of_paragraphs.asp"
...
If (CStr(Request("MM_delete")) <> "" And CStr(Request("MM_recordId")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    call log_the_page ("BBG Execute - DELETE Paragraph: " & MM_recordId)	
...
p_del.Source = "SELECT ID_page  FROM b_pages  WHERE ID_page = " + Replace(pid, "'", "''") + ""
p_del.CursorType = 0
...
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
  ...
  <input type="hidden" name="MM_recordId" value="<%= p_del.Fields.Item("ID_page").Value %>">
</form>
</body>
</HTML>
<%
