...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  MM_editRedirectUrl = "b_list_of_subjects.asp"
...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    call log_the_page ("BBG Execute - INSERT Subject")	
...
subjects.Source = "SELECT subjects.ID_subject, subjects.subject_name, subjects.subject_active_b, subjects.ID_subject   FROM subjects   GROUP BY subjects.ID_subject, subjects.subject_name, subjects.subject_active_b, subjects.ID_subject, subjects.subject_ord  ORDER BY subjects.subject_ord, subjects.ID_subject;"
...
<TITLE>BBP ADMIN: BBG Subjects. You are logged in as <%=Session("MM_Username_admin")%></TITLE>
...
<table>
  <tr> 
    <td align="left" valign="bottom" class="heading"> BBG subjects</td>
  </tr>
  <tr> 
    <td align="left" valign="bottom"> 
      <form name="add_subject" method="POST" action="<%=MM_editAction%>" onSubmit="<%call on_form_Submit(0)%>" onReset="<%call on_form_Reset%>">
        <table>
          <tr> 
            <td colspan="4" class="subheads">Subjects:</td>
            <td align="right" class="subheads" colspan="2">
			  <%if allow_word_export then %>
				<a href="_export_bbg.asp" target="_blank"><img src="images/wrd.gif" width="16" height="16" border="0" alt="Export all Subjects"></a> 
              <%end if %>
				<a href="b_order_subjects.asp"><img src="images/change.gif" width="15" height="15" border="0"></a>
			</td>
          </tr>
...
%>
          <tr class="table_normal" onMouseOver="pviiClassNew(this,'table_hl')" onMouseOut="pviiClassNew(this,'table_normal')"> 
            ...
            <td width="500" class="text" ><a href="../admin/b_list_of_topics.asp?subj=<%=(subjects.Fields.Item("ID_subject").Value)%>"><%=(subjects.Fields.Item("subject_name").Value)%></a></td>
            <td width="20"  align="right"> 
              <%if abs(subjects.Fields.Item("subject_active_b").Value) = 1 then response.write "<img src='images/1.gif'>" else response.write "<img src='images/0.gif'>"%>
            </td>
            <td width="20"  align="right"> 
              <%if allow_word_export then %>
              <a href="_export_bbg.asp?subj=<%=(subjects.Fields.Item("ID_subject").Value)%>" target="_blank"><img src="images/wrd.gif" width="16" height="16" border="0"></a> 
              <%end if %>
            </td>
            <td width="20"  align="right"><a href="../admin/b_edit_subject.asp?subj=<%=(subjects.Fields.Item("ID_subject").Value)%>"><img src="images/edit.gif" width="16" height="15" border="0"></a></td>
            <td width="20"  align="right"><a href="b_order_topics.asp?subj=<%=(subjects.Fields.Item("ID_subject").Value)%>"><img src="images/change.gif" width="15" height="15" border="0"></a></td>
          </tr>
          <% 
...
%>
          ...
          <tr> 
            <td >&nbsp;</td>
            <td colspan="5" >Sorry, 
              there are no subjects in the BBG currently.</td>
          </tr>
          ...
          <tr> 
            ...
            <td width="99%"  colspan="5"> 
              ...
              <input type="hidden" name="subject_active_q" value="0">
              <input type="hidden" name="subject_active_t" value="0">
              <input type="hidden" name="subject_active_b" value="1">
              <input type="hidden" name="subject_ord" value="999999">
            </td>
          </tr>
		  <tr > 
				<td align="center" valign="bottom" class="subheads" colspan="7"> 
					<br><BR><a href="javascript:" onClick="window.open('b_stats_of_subjects.asp','statswindow','scrollbars=yes,resizable=yes,width=700,height=500,left=50,top=50')">Click to view subject statistics</a>
				</td>
			</tr>
        </table>
...
<%
call log_the_page ("BBG List Subjects")
%>
