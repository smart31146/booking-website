...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  MM_fieldsStr  = "newbus|value | active|value"
...
business.Source = "SELECT * FROM q_info1"
...
<TITLE>BBP ADMIN: Business list. You are logged in as <%=Session("MM_Username_admin")%></TITLE>
...
function trySubmit()
{
	...
	{
		alert("Sorry, you must enter a name for a new business!\n(min. 2 characters)");
		return false;
	}
	if (confirm("Are you sure you want to add a new business?"))	{	document.forms[0].submit();
	return false;
	}
return false;
}
...
<table>
  <tr> 
    <td align="left" valign="bottom" class="heading"> Business list</td>
  </tr>
  <tr> 
    <td align="left" valign="bottom"> 
      <form name="add_bus" method="POST" action="<%=MM_editAction%>" onSubmit="<%call on_form_Submit(0)%>" onReset="<%call on_form_Reset%>">
        <table>
          <tr> 
            <td colspan="2" class="subheads">Businesses:</td>
...
%>
          <tr class="table_normal" onMouseOver="pviiClassNew(this,'table_hl')" onMouseOut="pviiClassNew(this,'table_normal')">
            ...
            <td width="560" class="text"><a href="../admin/business_level2.asp?business=<%=(business.Fields.Item("id_info1").Value)%>"><%=(business.Fields.Item("info1").Value)%></a></td>
            <td width="20" class="text">
				<%if business.Fields.Item("info1_active").Value then%>
					<img src="images/1.gif">
                <%else%>					
					<img src="images/0.gif">
				<%end if%>					
            </td>
            <td width="20"  align="right"><a href="../admin/business_edit_level1.asp?business=<%=(business.Fields.Item("id_info1").Value)%>"><img src="images/edit.gif" width="16" height="15" border="0"></a></td>
          </tr>
          <% 
...
%>
          ...
          <tr> 
            <td >&nbsp;</td>
            <td colspan="3" >Sorry, 
              there are no businesses in the BBP currently.</td>
          </tr>
          ...
          <tr> 
            ...
            <td width="99%"  colspan="2"> 
              ...
              <input type="submit" name="Submit" value="Add this new business" class="quiz_button" <%call IsEditOK%>>
            </td>
          </tr>
        </table>
