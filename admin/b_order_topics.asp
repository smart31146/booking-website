...
for iii = 1 to cInt(Request.form("field_length"))
  ...
  MM_editRedirectUrl = "b_list_of_subjects.asp?subj=" & subj
  ...
  If (Not MM_abortEdit) Then
    ...
    call log_the_page ("BBG Execute - UPDATE Topics: " & MM_recordId)
  End If
next
...
<TITLE>BBP ADMIN: Reference Topic order. You are logged in as <%=Session("MM_Username_admin")%></TITLE>
...
<table>
  <tr> 
    <td align="left" valign="bottom" class="heading"> BBG topics order</td>
  </tr>
  <tr> 
...
<%
call log_the_page ("BBG Reorder Topics " & subj)
%>
