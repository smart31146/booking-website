...
logConn.CommandTimeout = 360
logConn.Open Connect

set logs = Server.CreateObject("ADODB.Recordset")

logs.ActiveConnection = logConn
If (cint(Request("info1")) <> 0 OR cint(Request("info2")) <> 0 OR cint(Request("info3")) <> 0) then
	logs.Source = "SELECT * FROM logs, q_user " + SQL_where + " ORDER BY ID_log DESC;"
else
...
info2=request("info2")
info3=request("info3")%>
<!--<a href="log_export_results.asp?todate=<%=todate%>&fromdate=<%=fromdate%>&module=<%=module%>&subject=<%=subject%>&username=<%=username%>&ipaddress=<%=ipaddress%>&comment=<%=comment%>&info1=<%=info1%>&info2=<%=info2%>&info3=<%=info3%>"><img src="images/xls.gif" border=0></a>-->
<td align="right" class="subheads" valign="top"><br><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Click on the image for Excel format : <a href="logs_export_results.asp?todate=<%=todate%>&fromdate=<%=fromdate%>&ipaddress=<%=ipaddress%>&module=<%=module%>&subject=<%=subject%>&username=<%=username%>&comment=<%=comment%>&info1=<%=info1%>&info2=<%=info2%>&info3=<%=info3%>"><img src="images/xls.gif" width="16" height="16" border="0"></a>
</td>
</tr>
</table>
<table width="300" border="0" cellspacing="2" cellpadding="0">
  <tr>
    <td width="120"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Starting
      date:</font></td>
    <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=fromdate%></font></b></td>
  </tr>
  <tr>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Ending date:</font></td>
    <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=todate%></font></b></td>
  </tr>
  <tr>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="1">IP address:</font></td>
    <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=ipaddress%></font></b></td>
  </tr>
  <tr>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Module:</font></td>
    <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=module%></font></b></td>
  </tr>
  <tr>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="1">User name:</font></td>
    <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=username%></font></b></td>
  </tr>
  <tr>
    ...
    <%
    if subject <> 0 then
		Response.Write subjects("subject_name")
		subjects.close
	end if
  ...
  <tr>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Comment:</font></td>
    <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=comment%></font></b></td>
  </tr>
  <tr>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Business Group:</font></td>
    <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">
    <%
    if info1 <> 0 then
  ...
  <tr>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Business <% =BBPinfo3 %>:</font></td>
    <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">
    <%
    if info2 <> 0 then
  ...
  <tr>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><% =BBPinfo3 %>:</font></td>
    <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">
    <%
    if info3 <> 0 then
  ...
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr bgcolor="#333333">
          <td width="3%"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="1">ID</font></td>
          <td width="5%"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="1">Date</font></td>
          <td width="7%"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="1">IP
            address</font></td>
          <td width="7%"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="1">Module</font></td>
          <td width="10%"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="1">User
            name</font></td>
          <td width="7%"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="1">Subject</font></td>
          <td width="15%"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="1">Topic</font></td>
          <td width="3%"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="1">Page</font></td>
          <td width="30%"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="1">URL</font></td>
          <td width="15%"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="1">Comment</font></td>
        </tr>
        <%
While ((Repeat1__numRows <> 0) AND (NOT logs.EOF))
%>
        <tr bgcolor="#FFFFFF">
          <td><font size="1"><%=(logs.Fields.Item("ID_log").Value)%></font></td>
          <td><font size="1"><%= Replace(cStr(Replace(logs.Fields.Item("log_date").Value, "-", "/")), "'", "''")%></font></td>
          <td><font size="1"><%=(logs.Fields.Item("log_IP").Value)%></font></td>
          <td><font size="1"><%=(logs.Fields.Item("log_module").Value)%></font></td>
          <td><font size="1"><%=(logs.Fields.Item("log_user").Value)%></font></td>
          <td><font size="1"><%=(logs.Fields.Item("log_subj").Value)%></font></td>
          <td><font size="1"><%=(logs.Fields.Item("log_topic").Value)%></font></td>
          <td><font size="1"><%=(logs.Fields.Item("log_page").Value)%></font></td>
          <td><font size="1"><%=(logs.Fields.Item("log_url").Value)%></font></td>
          <td><font size="1"><%=(logs.Fields.Item("log_comment").Value)%></font></td>
        </tr>
        <%
...
%>
        <tr bgcolor="#FFFFFF">
          ...
          <td colspan="10"><font size="2">Sorry,
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="3">
      <table border="0" width="50%" align="center" cellpadding="0" cellspacing="1">
        <tr bgcolor="#999999">
          <td width="25%" align="center"> <b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
            <% If MM_offset <> 0 Then %>
  ...
  <tr align="center">
    <td colspan="3"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><i>&nbsp;
      </i></font>
<form name="form1" method="post" action="">
      ...
      <font face="Verdana, Arial, Helvetica, sans-serif" size="2"><i> </i></font></td>
  </tr>
  <tr align="center">
    <td colspan="3"><a href="javascript:" onClick="window.close();"><font size="2"><b><i><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Back
      to the search entry page</font></i></b></font></a></td>
  </tr>
  <tr align="center">
    <td width="33%" align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Log
      generated on: <%= Now()%></font></td>
    <td width="33%"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Application
      name: <%=client_name_long%></font></td>
    <td width="33%" align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Generated
      from IP: <%=Request.ServerVariables("REMOTE_ADDR")%></font></td>
  </tr>
</table>
<p>&nbsp;</p>
<p>&nbsp;</p>
