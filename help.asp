...
<body id="b" style="background: url('images/bg.jpg') no-repeat;width:auto;height:1000;position:relative;">
<div class="main_content" style="margin: 0 auto;">
		...
		<strong style="font-size:20px;">HELP</strong><br><br>
		Need support or assistance? Please contact:
		<br><br>
		<table  style="width:100%; padding-right:100px; padding-left:150px;"  cellspacing=0 cellpadding=0>
		<tr>
		
		<td valign=top align=left style="padding-left:5px;">
		<b>Aus,NZ,EMEA and Asia:</b>
		<div style="font-size:12px;color:white">
		Email: <a href="mailto:HRAssistAus@tweglobal.com">HRAssistAus@tweglobal.com</a>
		<br>Ph: 1300 185 015 (inside Australia) or 
		<br>+61 8 8301 5536 (outside Australia)
		</div>
		</td>
		<td valign=top align=left style="padding-left:5px;">
		...
		<b>Americas:</b>
		<div style="font-size:12px;color:white">
		Email: <a href="mailto:HRAssistNapa@tweglobal.com">HRAssistNapa@tweglobal.com</a>
		<br>Ph: 866-921-5479 (x5499) 
		</div>		
		</td>
		</tr>
		</table>
...
<strong style="font-size:20px;">TECHNICAL HELP</strong><br><br>
		Need technical support or assistance? Please contact:
		<br>
		<p style="text-align: center;font-size:13px;" >
		<b>TWE IT Service Desk:</b>myIT
		<br>
		Email: <a href="mailto:ITServiceDesk@tweglobal.com">ITServiceDesk@tweglobal.com</a>
		<br>
		Self Service: <a href="http://myit.tweglobal.com/" target="_blank">http://myit.tweglobal.com/</a>
		</p>
		<br>
		<br>
		<br>
		...
		<td valign=top align=left style="padding-left:5px; border-left:1px #ccc solid">
		<b>AUSTRALIA</b>
		<div style="font-size:12px;color:white">
		Local: 1300 185 101
		<br>Direct: +61 3 8533 3200 
		<br>Ext: 3200
		</div>
		</td>
		<td valign=top align=left style="padding-left:5px; border-left:1px #ccc solid">
		...
		<b >AMERICA</b>
			<div style="font-size:12px;color:white">
		Toll free: 877 854 7797
		<br>Direct: +1 707 299 3200 
		<br>Ext: 3200
		</div>
		</td>
		<td valign=top align=left style="padding-left:5px; border-left:1px #ccc solid">
		...
		<b>NEW ZEALAND</b>
			<div style="font-size:12px;color:white">
		<b>Parnel Office</b> Ext: 5255
		<br><b>Matua Waimauku</b> office Ext: 3200
		<br>
		<b>All other NZ locations</b>
		 <br>Direct: 09 354 5255
		</div>
		</td>
		<td valign=top align=left style="padding-left:5px; border-left:1px #ccc solid">
